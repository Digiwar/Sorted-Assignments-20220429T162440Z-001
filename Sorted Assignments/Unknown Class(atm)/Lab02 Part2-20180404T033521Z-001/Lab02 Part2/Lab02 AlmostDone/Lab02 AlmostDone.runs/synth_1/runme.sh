...
HD_PWD='C:/Users/leexu/Desktop/Lab02 Part2/multi_tb/multi_tb.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multi_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multi_tb.tcl
