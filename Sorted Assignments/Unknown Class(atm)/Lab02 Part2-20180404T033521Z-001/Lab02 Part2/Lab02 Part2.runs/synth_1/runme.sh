...
HD_PWD='C:/Users/leexu/Desktop/Lab02 Part2/Lab02 Part2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_test.tcl
